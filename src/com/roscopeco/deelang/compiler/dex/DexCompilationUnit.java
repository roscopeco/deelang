...
/**
 * <p>A Dex compilation unit. This encapsulates all data and visitor
 * logic for the script being compiled, and outputs Dalvik Executable
 * (DEX) bytecode for use in the Android environment.</p>
 * 
 ...
 * complete, the {@link #getCode()} method is called to generate
 * the DEX bytecode.</p>
 * 
 * <p>This class also provides convenience methods ({@link #getScript()}) that
 * define a new class at runtime from the generated bytecode. These methods 
 * allow a {@code ClassLoader} to be supplied, but will use a sensible default
