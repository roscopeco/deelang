...
public class FuncTestCompilerMethodCalls extends CompilerFuncTestBase {
  ...
  public void testBasicFuncCallNoArgs() throws ParserError, CompilerError {
    runCodeComparisonTest("foo()", 
        ...
        "                this:v1   //com.roscopeco.deelang.runtime.DexCompiledScript__UUID__\n"+
  ...
  public void testBasicFuncCallOneArg() throws ParserError, CompilerError {
    runCodeComparisonTest("foo(1)", 
        ...
        "INVOKE_DIRECT       |     |v0.<init>(v4,v1)  //Ldee/lang/DeelangInteger;.<init>(Ldee/lang/Binding;I)V\n"+
  ...
  public void testBasicFuncNoArgsCallWithBlock() throws ParserError, CompilerError {
    runCodeComparisonTest("blockNoArgs() { voidy() }", 
        ...
        "INVOKE_DIRECT       |     |v0.<init>(v5,v6,v2)  //Lcom/roscopeco/deelang/runtime/DexCompiledScript__UUID__$block0;.<init>(Ldee/lang/DeelangObject;Ldee/lang/Binding;[Ljava/lang/Object;)V\n"+
        "INVOKE_VIRTUAL      |     |v5.blockNoArgs(v0)  //Lcom/roscopeco/deelang/compiler/dex/CompilerFuncTestBase$Foo;.blockNoArgs(Ldee/lang/Block;)V\n"+
        "CONST               |     |v3=0x00000000  // int:0   float:0.000000\n"+
        "IPUT                |     |v0.inScope=v3  //Lcom/roscopeco/deelang/runtime/DexBlock;.inScope Z\n"+
        "RETURN_VOID         |     |return",
        
        "extends com.roscopeco.deelang.runtime.DexBlock",
        "public final V invoke(dee.lang.DeelangObject,dee.lang.Binding,java.lang.Object[],java.lang.Object[])\n"+
  ...
  public void testBasicMethCallNoArgsWithBlock() throws ParserError, CompilerError {
    runCodeComparisonTest("foo.blockNoArgs() { foo.voidy() }", 
        ...
        "INVOKE_DIRECT       |     |v4.<init>(v9,v10,v6)  //Lcom/roscopeco/deelang/runtime/DexCompiledScript__UUID__$block0;.<init>(Ldee/lang/DeelangObject;Ldee/lang/Binding;[Ljava/lang/Object;)V\n"+
  ...
  public void testBlockConstructorIsCorrect() throws ParserError, CompilerError {
    runCodeComparisonTest("blockNoArgs() { voidy() }", 
        "extends com.roscopeco.deelang.runtime.DexBlock",
        "//Lcom/roscopeco/deelang/runtime/DexCompiledScript__UUID__$block0;.<init>(Ldee/lang/DeelangObject;Ldee/lang/Binding;[Ljava/lang/Object;)V\n"+
        "public V <init>(dee.lang.DeelangObject,dee.lang.Binding,java.lang.Object[])\n"+
        "                this:v0   //com.roscopeco.deelang.runtime.DexCompiledScript__UUID__$block0\n"+
        "                    :v1   //dee.lang.DeelangObject\n"+
        "                    :v2   //dee.lang.Binding\n"+
        "                    :v3   //java.lang.Object[]\n"+
        "INVOKE_DIRECT       |     |v0.<init>(v1,v2,v3)  //Lcom/roscopeco/deelang/runtime/DexBlock;.<init>(Ldee/lang/DeelangObject;Ldee/lang/Binding;[Ljava/lang/Object;)V\n"+
        "RETURN_VOID         |     |return");        
  }
  ...
  public void testBasicMethCallWithArgsWithBlock() throws ParserError, CompilerError {
    runCodeComparisonTest("foo.blockOneArg(1) { foo.voidy() }", 
        ...
        "INVOKE_DIRECT       |     |v6.<init>(v10,v11,v7)  //Lcom/roscopeco/deelang/runtime/DexCompiledScript__UUID__$block0;.<init>(Ldee/lang/DeelangObject;Ldee/lang/Binding;[Ljava/lang/Object;)V\n"+
  ...
  public void testBasicMethCallNoArgsWithBlockModifiyingLoadedLocal() throws ParserError, CompilerError {
    runCodeComparisonTest("a = 2; foo.blockNoArgs() { a = 1 }", 
        ...
        "INVOKE_DIRECT       |     |v7.<init>(v11,v12,v8)  //Lcom/roscopeco/deelang/runtime/DexCompiledScript__UUID__$block0;.<init>(Ldee/lang/DeelangObject;Ldee/lang/Binding;[Ljava/lang/Object;)V\n"+
  ...
  public void testBasicFuncNoArgsCallWithOrBlock() throws ParserError, CompilerError {
    runCodeComparisonTest("voidy() or { voidy() }", 
        ...
        "NEW_INSTANCE        |     |v0=NEW Lcom/roscopeco/deelang/runtime/DexCompiledScript__UUID__$block0;\n"+
        "INVOKE_DIRECT       |     |v0.<init>(v5,v6,v2)  //Lcom/roscopeco/deelang/runtime/DexCompiledScript__UUID__$block0;.<init>(Ldee/lang/DeelangObject;Ldee/lang/Binding;[Ljava/lang/Object;)V\n"+
        "INVOKE_VIRTUAL      |     |v5.or(v0)  //Ldee/lang/DeelangObject;.or(Ldee/lang/Block;)V\n"+
        "CONST               |     |v3=0x00000000  // int:0   float:0.000000\n"+
        "IPUT                |     |v0.inScope=v3  //Lcom/roscopeco/deelang/runtime/DexBlock;.inScope Z\n"+
        "RETURN_VOID         |     |return",
  ...
  public void testBasicFuncNoArgsCallWithBlockAndOrBlock() throws ParserError, CompilerError {
    runCodeComparisonTest("blockNoArgs() { bar(4) } or { voidy() }", 
        ...
        "INVOKE_DIRECT       |     |v0.<init>(v5,v6,v2)  //Lcom/roscopeco/deelang/runtime/DexCompiledScript__UUID__$block1;.<init>(Ldee/lang/DeelangObject;Ldee/lang/Binding;[Ljava/lang/Object;)V\n"+
        "INVOKE_VIRTUAL      |     |v5.or(v0)  //Ldee/lang/DeelangObject;.or(Ldee/lang/Block;)V\n"+
        "CONST               |     |v3=0x00000000  // int:0   float:0.000000\n"+
        "IPUT                |     |v0.inScope=v3  //Lcom/roscopeco/deelang/runtime/DexBlock;.inScope Z\n"+
        "RETURN_VOID         |     |return",
